...
public class VSUMExample {
  public static void main(String[] args) throws Exception {
    ...
    modifyView(view, (CommittableView v) -> {
      v.getRootObjects().add(BrakesystemFactory.eINSTANCE.createBrakesystem());
    });
  }

  private static VirtualModel createDefaultVirtualModel() throws java.io.IOException {
    return new VirtualModelBuilder()
        .withStorageFolder(Path.of("vsumexample"))
        .withUserInteractorForResultProvider(new TestUserInteraction.ResultProvider(new TestUserInteraction()))
        .withChangePropagationSpecifications(new Brakesystem2cadChangePropagationSpecification())
        .buildAndInitialize();
  }
